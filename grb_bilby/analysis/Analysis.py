...
def load_data(GRB, path='GRBData', truncate=True, truncate_method='prompt_time_error'):
    """
...
def plot_data(GRB, path, truncate, truncate_method='prompt_time_error', axes=None, colour='k'):
    """
    plots the data
