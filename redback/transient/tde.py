...
class TDE(OpticalTransient):
    """
    Class for tidal disruption event (TDE) transient data.

    Inherits from OpticalTransient and provides TDE-specific data loading and processing.
    ...
    def __init__(
        ...
        """
        General constructor for the TDE class.
        ...
        ----------
        name : str
            Name of the transient (e.g., 'ASASSN-14li').
        data_mode : str, optional
            Data mode. Must be one from `TDE.DATA_MODES` (default is 'magnitude').
        ...
        **kwargs : dict, optional
        ...
        --------
        >>> import redback
        >>> tde = redback.tde.TDE.from_open_access_catalogue('ASASSN-14li')
        """
