...
class Supernova(OpticalTransient):
    """
    Class for supernova transient data.

    Inherits from OpticalTransient and provides supernova-specific data loading and processing.
    ...
    def __init__(
        ...
        """
        General constructor for the Supernova class.
        ...
        ----------
        name : str
            Name of the transient (e.g., 'SN2011fe').
        data_mode : str, optional
            Data mode. Must be one from `Supernova.DATA_MODES` (default is 'magnitude').
        ...
        active_bands : Union[np.ndarray, str], optional
            List or array of active bands to be used in the analysis. Use all available
            bands if 'all' is given (default is 'all').
        ...
        optical_data : bool, optional
            Whether we are fitting optical data, useful for plotting (default is True).
        **kwargs : dict, optional
        ...
        --------
        >>> import redback
        >>> supernova = redback.supernova.Supernova.from_open_access_catalogue('SN2011fe')
        """
