...
<<<<<<< HEAD
def tophatredback_and_twolayerstratified(time, redshift, av, thv, loge0, thc, logn0, p, logepse, logepsb, xiN, g0, mej, vej_1, vej_2, kappa, beta, **kwargs):
    
    """
    function to combine the flux density signals of a tophat_redback afterglow from an emulator and a two layer stratified kilonova, with extinction
    ...
    afterglow = redback.transient_models.extinction_models.extinction_with_afterglow_base_model(time=time, redshift=redshift, av=av,
         thv=thv, loge0=loge0 , thc= thc, logn0=logn0, p=p, logepse=logepse, logepsb=logepsb, xiN=xiN, g0=g0,
        **kwargs)
    kwargs['base_model']='two_layer_stratified_kilonova'
...
>>>>>>> ef70edcdadc74e1a8fc8ab6e5f9363bb6df8d715
