...
class Piecewise_polytrope(object):
    ...
    def Lambda_of_mass(self, central_pressure, mass, maximum_mass_limit=1.97):
        """
        ...
        """
        mass_tmp, Lambda_tmp, max_mass = self.Lambda_array_of_central_pressure(central_pressure, maximum_mass_limit)
