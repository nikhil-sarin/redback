...
def get_xrt_data_from_swift(grb: str, data_mode: str = None, **kwargs: dict) -> redback.get_data.swift.SwiftDataGetter:
    return get_swift_data(grb=grb, transient_type='afterglow', data_mode=data_mode, instrument="XRT")


def get_afterglow_data_from_swift(grb: str, data_mode: str, **kwargs: dict) -> redback.get_data.swift.SwiftDataGetter:
    return get_swift_data(grb=grb, transient_type='afterglow', data_mode=data_mode, instrument="BAT+XRT")


def get_prompt_data_from_swift(grb: str, bin_size: str = "1s", **kwargs: dict) -> redback.get_data.swift.SwiftDataGetter:
...
def get_swift_data(
        ...
        bin_size: str = None) -> redback.get_data.swift.SwiftDataGetter:
