...
class TimeSuite:
    ...
    def time_simulate_kilonova(self):
        """Time the simulation of a kilonova transient. This is copied from the example in
        examples/simulate_kilonova.py."""
        ...
        _ = SimulateOpticalTransient.simulate_transient(
