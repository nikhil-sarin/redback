...
priors['temperature_floor_1'] = bilby.core.prior.Uniform(
    3000, 8000, 'temperature_floor_1', latex_label=r'$T_{\rm floor,1}$')
...
priors['temperature_floor_2'] = bilby.core.prior.Uniform(
    1000, 5000, 'temperature_floor_2', latex_label=r'$T_{\rm floor,2}$')
...
optical_priors.update({k: v for k, v in priors.items()
                      if k in ['redshift', 'mej_1', 'vej_1', 'kappa_1',
                              'temperature_floor_1', 'mej_2', 'vej_2',
                              'kappa_2', 'temperature_floor_2']})
...
parameter_mappings = {
    'xray': {'viewing_angle': 'thv'},
    'radio': {'viewing_angle': 'thv'}
}
